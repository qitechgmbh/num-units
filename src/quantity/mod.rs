...
/// let length = length::f64::Length::from_raw(5.0);
/// let width = length::f64::Length::from_raw(3.0);
/// let total_length = length + width; // Same dimensions - addition works
///
/// let time = time::f64::Time::from_raw(2.0);
...
mod tests {
    ...
    fn test_quantity_creation() {
        ...
        let length = crate::length::f64::Length::from_raw(5.0);
    ...
    fn test_quantity_macro() {
        ...
        let length = crate::length::f64::Length::from_raw(2.5);
        let area = crate::area::f64::Area::from_raw(9.8);
    ...
    #[test]
    fn test_display() {
        let length = crate::length::f64::Length::from_raw(3.14159);
    ...
    fn test_motion_system_integration() {
        ...
        let length = crate::length::f64::Length::from_raw(10.0);
        let time = crate::time::f64::Time::from_raw(2.0);
